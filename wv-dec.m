...
legend('horizontal kinetic energy', 'rotational component', 'divergent component', loc=3)
...
xlabel('wavenumber [rad/m]')
ylabel('power spectral density [kg/s^2]')
legend('total energy', 'diagnosed wave component', 'residual vortical component', loc=3)
